...
public class PlayScreen implements Screen {
    ...
    public void show() {
        ...
        String shot = tankWars.getPlayer().getTank().getGun().getShot().getShotImgSrc();
        ...
        tankSprite.setPosition((float) tankWars.getPlayer().getTank().getPos().getX(),
                (float) tankWars.getPlayer().getTank().getPos().getY());
    ...
    public void render(float delta) {
        ...
        if(tankWars.getPlayer().getTank().getGun().getShot().isVisible()){
            shotSprite.setPosition((float) tankWars.getPlayer().getTank().getGun().getShot().getPosition().getX() ,
                                    (float) tankWars.getPlayer().getTank().getGun().getShot().getPosition().getY());
        ...
        System.out.println("Angle: " + tankWars.getPlayer().getTank().getAngle() +
                ...
                "\n Shotpos: (" + tankWars.getPlayer().getTank().getGun().getShot().getPosition().getX() +
                ", " + tankWars.getPlayer().getTank().getGun().getShot().getPosition().getY() + ")");
